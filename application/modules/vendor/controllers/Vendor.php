...
class Vendor extends CI_Controller {
    ...
    function data(){
    $this->load->view('v_vendor_data');
    }

    function editor(){
    $this->load->view('v_vendor_editor');
    }
    ...
    public function page()
    {
      ...
      $data = $this->M_vendor->get_data($search,$from_page,$per_page); // ambil data
    ...
    function add(){
        ...
        $insert = $this->M_vendor->insert($data);
        if (!$insert) {
    ...
    function update(){
      ...
      parse_str($_POST['data'], $data);
      $id = $data['id_vendor'];
      $update = $this->M_vendor->update_by_id($data,$id);
    }

    // fungsi hapus
    function delete(){
      $id = $this->input->post('id');
      $delete = $this->M_vendor->delete_by_id($id);
    }
