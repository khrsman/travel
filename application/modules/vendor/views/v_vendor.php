...
<link rel="stylesheet" href="<?php echo base_url() ?>css/khrsman-pagination.css" />
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
          <button class="btn bg-purple" id="btn_add" style="margin-bottom:10px"><span class="fa fa-plus"></span> Tambah vendor</button>
...
$(document).ready(function(){
  var request = $.get("<?php echo base_url(); ?>vendor/data");
