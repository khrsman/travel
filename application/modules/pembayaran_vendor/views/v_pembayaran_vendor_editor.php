        ...
        <div class="box box-primary  box-solid">
            ...
            <div class="box-body">
                <form role="form" class="form-horizontal xform">
                    ...
                    <input type="hidden" id="id_pembayaran_vendor" name="id_pembayaran_vendor">
                    <div class="form-group">
        ...
        <div class="box box-success  box-solid" id="aksi" style="display:none">
            ...
            <div class="box-body">
                <div class="aksi" display="none">
                    ...
                    <a class="btn btn-primary download" id="download_penawaran"><span class="fa fa-remove "></span> Download Kwitansi</a>
                </div>
            </div>
            <div class="box-footer" style="text-align:right">
...
<script>
    $(document).ready(function() {
        ...
        function redirect() {
            id = $("#id_booking").val();
            $.get("<?php echo base_url('booking/view_invoice')?>", {
                id: id
            }).done(function(data) {
        ...
        $('#btn_simpan_pembayaran').click(function() {
            ...
            request = $.post("<?php echo base_url('pembayaran_vendor') ?>/add", {
                data: data
            });
