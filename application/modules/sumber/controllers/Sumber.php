...
class Sumber extends CI_Controller {
    ...
    function data(){
    $this->load->view('v_sumber_data');
    }

    function editor(){
    $this->load->view('v_sumber_editor');
    }
    ...
    public function page()
    {
      ...
      $data = $this->M_sumber->get_data($search,$from_page,$per_page); // ambil data
    ...
    function add(){
        ...
        if (isset($data['id_sumber'])) {
          $data['id_sumber'] = NULL;
        };
        $insert = $this->M_sumber->insert($data);
        if (!$insert) {
    ...
    function update(){
      ...
      parse_str($_POST['data'], $data);
      $id = $data['id_sumber'];
      $update = $this->M_sumber->update_by_id($data,$id);
    }

    // fungsi hapus
    function delete(){
      $id = $this->input->post('id');
      $delete = $this->M_sumber->delete_by_id($id);
    }
